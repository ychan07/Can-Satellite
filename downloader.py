...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "mangaHI_csv_files")

# 🌐 CSV 파일이 있는 웹사이트 주소
BASE_URL = "https://www.gb.nrao.edu/GbtLegacyArchive/HI-MANGA/DR4/spectra/csv/"
MAX_THREADS = 20  # 병렬 다운로드 수 (인터넷 환경에 따라 조정)
